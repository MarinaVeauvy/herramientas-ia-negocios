...
const SITE_NAME = 'IA para Negocios';
...
const TOPICS = [
  "Las Mejores Herramientas de IA para Pequeñas Empresas en 2026",
  "Cómo Automatizar la Atención al Cliente con Chatbots de IA",
  "Herramientas de IA para Marketing Digital con Presupuesto Limitado",
  "IA para Contabilidad y Facturación: Comparativa Completa",
  "Cómo Usar IA para Gestionar Redes Sociales de tu Negocio",
  "Las Mejores Herramientas de IA para Tiendas Online",
  "IA para Recursos Humanos en Equipos Pequeños",
  "Cómo Usar IA para Pronósticos de Ventas en tu Empresa",
  "Herramientas de IA para Email Marketing: Guía Completa",
  "IA para Restaurantes y Negocios de Alimentación",
  "Cómo Crear un Plan de Negocios con Asistencia de IA",
  "Las Mejores Herramientas de IA para Gestión de Inventario",
  "IA para SEO Local: Herramientas que Realmente Funcionan",
  "Cómo Reducir Costos Operativos con Inteligencia Artificial",
  "Herramientas de IA para Autónomos que Emprenden"
];
...
async function generateArticle(topic) {
  const res = await fetch(`https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash:generateContent?key=${GEMINI_KEY}`, {
    ...
    body: JSON.stringify({
      contents: [{ parts: [{ text: `Eres un experto redactor de reseñas tecnológicas en español (España/Latinoamérica). Escribe un artículo de 2000-3000 palabras sobre: ${topic}. Incluye comparaciones prácticas, precios, ventajas y desventajas. Incluye 2-3 enlaces de afiliado de Amazon: https://www.amazon.com/dp/{ASIN}?tag=${AMAZON_TAG}. Usa estos ASINs: 0593418484 (Hábitos Atómicos), 0062960067 (AI Superpowers), 1591847818 (The Hard Thing About Hard Things). Solo HTML (H2,H3,tablas,listas,p). Sin etiquetas html/head/body. Responde en JSON: {"title":"...","slug":"...","excerpt":"...","content":"..."}. El slug debe estar en español con guiones. Todo el contenido DEBE estar en español.` }] }],
